...
//    let test: Cactus
    ...
    static let colorOptions: [Color] = [ accentYellow, blue, purple, grape, pink, red, yellow,  ]
    ...
    static let accentYellow = makeColor(230, 187, 18)
    static let lightAccentGreen = makeColor(230, 187, 18)
...
//    fonts
    static let titleFont: ProvidedFont = .helvetica
    static let mainFont: ProvidedFont = .helvetica

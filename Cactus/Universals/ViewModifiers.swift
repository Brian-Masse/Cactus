...
private struct UniversalForegroundColor: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content
            .foregroundColor(colorScheme == .light ? Colors.lightAccentGreen : Colors.accentYellow)
    }
}
...
private struct UniversalBackgroundColor: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content
            .if(ignoreSafeAreas == nil ) { view in view.background(colorScheme == .light ? Colors.lightAccentGreen : Colors.accentYellow) }
            .if(ignoreSafeAreas != nil ) { view in view.background(colorScheme == .light ? Colors.lightAccentGreen : Colors.accentYellow, ignoresSafeAreaEdges: ignoreSafeAreas!) }
